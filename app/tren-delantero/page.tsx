...
export default function TrenDelanteroPage() {
    ...
    // Diagnosis Grid Variants (Staggered)
            ...
            <section className="py-24 bg-white">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
                        <motion.div
                            className="relative aspect-[4/3] bg-zinc-200 shadow-xl border-4 border-zinc-100"
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
                        ...
                        <motion.div
                            className="relative aspect-[4/3] bg-zinc-200 shadow-xl border-4 border-zinc-100 order-1 lg:order-2"
                            initial={{ opacity: 0, x: 50 }}
                            whileInView={{ opacity: 1, x: 0 }}
                            viewport={{ once: true, amount: 0.2 }}
                            transition={{ duration: 0.6, ease: "easeOut" }}
