...
import { ArrowLeft, Clock, ShieldCheck, Thermometer, Cog } from "lucide-react"
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="pt-6">
                                <a
                                    href={`https://api.whatsapp.com/send/?phone=543856981610&text=Hola%21%20Me%20interesa%20realizar%20un%20servicio%20de%20${product.name}`}
                                    target="_blank"
