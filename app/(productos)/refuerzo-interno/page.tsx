...
import { refuerzoCatalog, type RefuerzoProduct } from "@/lib/data-refuerzo"
import {
    Tractor,
    ArrowRight,
    ShieldCheck,
...
// --- TARJETA DE PRODUCTO (Refuerzo) ---
function ProductCard({ product, isMobile }: { product: RefuerzoProduct; isMobile: boolean }) {
    return (
        <Link href={`/refuerzo-interno/${product.id}`} className="block">
            <motion.div
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-end">
                        ...
                        >
                            <p className="text-lg text-muted-foreground leading-relaxed border-l-2 border-primary pl-6 py-2">
                                Soluciones estructurales para recuperar la carcasa y garantizar la resistencia en el trabajo pesado. Prolongamos la vida útil de su inversión.
                            </p>
                        </motion.div>
                    </div>
                </div>
