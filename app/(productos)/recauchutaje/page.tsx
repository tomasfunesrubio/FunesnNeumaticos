...
import { recauchutajeCatalog, type RecauchutajeProduct } from "@/lib/data-recauchutaje"
import {
    Tractor,
    ArrowRight,
    Ruler,
...
// --- TARJETA DE PRODUCTO (Recauchutaje) ---
function ProductCard({ product, isMobile }: { product: RecauchutajeProduct; isMobile: boolean }) {
    return (
        <Link href={`/recauchutaje/${product.id}`} className="block">
            <motion.div
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-end">
                        ...
                        >
                            <p className="text-lg text-muted-foreground leading-relaxed border-l-2 border-primary pl-6 py-2">
                                Recuperación integral para maquinaria agrícola. Extendemos la vida operativa de tus neumáticos con procesos certificados que garantizan seguridad y rendimiento en el campo.
                            </p>
                        </motion.div>
                    </div>
                </div>
