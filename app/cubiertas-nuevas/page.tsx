...
import { Search, MessageCircle, Package, ArrowLeft, Filter } from 'lucide-react'
import { Button } from '@/components/ui/button'
import { Input } from '@/components/ui/input'
import { Footer } from '@/components/footer'
import { neumaticosCatalog, categories, type Neumatico } from '@/lib/data-neumaticos-nuevos'

const WHATSAPP_NUMBER = '5493855711696'

function ProductCard({ product }: { product: Neumatico }) {
