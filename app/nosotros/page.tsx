  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="pt-40 pb-20 bg-background text-foreground relative border-b border-border overflow-hidden">
        ...
        <div className="absolute top-1/2 right-[-50px] md:right-10 -translate-y-1/2 opacity-[0.05] pointer-events-none select-none z-0">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            {values.map((value, index) => (
              <div
                key={value.title}
                className="group p-8 bg-white border-2 border-border hover:border-primary transition-all duration-300 relative shadow-sm hover:shadow-lg hover:-translate-y-1"
              >
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              {milestones.map((milestone, index) => (
                ...
                >
                  <div className={`flex-1 w-full pl-12 md:pl-0 ${index % 2 === 0 ? 'md:pr-12 md:text-right' : 'md:pl-12 md:text-left'}`}>
