          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-24">
              {values.map((value, index) => (
                <div 
                    key={value.title} 
                    className="group relative bg-background border border-border p-8 transition-all hover:border-primary/50"
                >
            ...
            <div className="w-full shadow-2xl border-y border-primary/20">
                <div className="grid lg:grid-cols-2 bg-white">
                    ...
                    <div className="relative min-h-[400px] lg:min-h-full border-b lg:border-b-0 lg:border-r border-zinc-800 group overflow-hidden bg-zinc-900">
                    ...
                    <div className="p-10 lg:p-16 relative bg-white text-foreground">
