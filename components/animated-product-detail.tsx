            ...
            <section className="py-16 bg-zinc-50">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        ...
                        {/* LEFT: Product Image (CLS Optimized) */}
                        <motion.div
                            initial={{ opacity: 0, scale: 0.95 }}
                            animate={{ opacity: 1, scale: 1 }}
                            transition={{ duration: 0.6, delay: 0.2 }}
                            className="relative bg-white border-2 border-zinc-200 p-12 lg:p-16"
                        >
                        ...
                        <div className="space-y-8">
                            <motion.div
                                ...
                                className="inline-flex items-center gap-2 bg-zinc-900 text-white px-4 py-2 font-mono text-xs uppercase tracking-widest"
                            >
                                {badgeText}
                            </motion.div>
                            ...
                            <motion.p
                                ...
                                animate={{ opacity: 1, x: 0 }}
                                transition={{ duration: 0.5, delay: 0.5 }}
                                className="text-lg text-zinc-600 leading-relaxed border-l-4 border-primary pl-6 py-2"
                            >
                                {description}
                            </motion.p>
...
// Wrapper helper to ensure specs have consistent styling but can be anything
